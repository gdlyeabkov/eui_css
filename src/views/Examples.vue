        ...
        <div>
            <div style="float: left; width: 55%;">
                ...
                <div style="margin: 15px;">
                    <button class="hui-button  hui-error" @click="$router.push({ name: 'GetStarted' })">Скачать примеры</button>
                    <button class="hui-button  hui-light" @click="$router.push({ name: 'Download' })">Скачать исходный код</button>
                </div>

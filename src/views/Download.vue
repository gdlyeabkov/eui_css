<template>
    <div>
        ...
        <div class="hui-main">
            ...
            <p>
                Загрузите готовый скомпилированный код для Bootstrap v5.1.1, чтобы легко вставить его в свой проект, который включает:
            </p>
            <ul>
                <li>
                ...
                <li>
                    Скомпилированные и минифицированные плагины JavaScript (см. Сравнение файлов JS)
                </li>
            </ul>
            <p>
